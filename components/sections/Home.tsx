  ...
  return (
      <section 
        ...
        <div className="grid md:grid-cols-[1.5fr_1fr] gap-10 items-center w-full">
          <div>
        <h1 className="text-5xl font-bold mb-12 text-[var(--heading)] transition-shadow duration-300 hover:[text-shadow:0_0_16px_rgb(var(--accent)/0.8)]">Maroia Baani</h1>
        ...
        <div className="flex gap-3 mt-6">
          <a
            ...
            rel="noreferrer"
            aria-label="LinkedIn"
            className="flex items-center justify-center w-10 h-10 border border-[var(--card-border)] rounded-full transition-shadow duration-300 hover:shadow-[0_0_14px_3px_rgb(var(--accent)/0.5)] hover:border-[var(--accent-text)]"
          >
            <svg viewBox="0 0 24 24" className="w-5 h-5 text-[var(--accent-text)]" fill="currentColor">
          ...
          <a
            ...
            className="flex items-center justify-center w-10 h-10 border border-[var(--card-border)] rounded-full transition-shadow duration-300 hover:shadow-[0_0_14px_3px_rgb(var(--accent)/0.5)] hover:border-[var(--accent-text)]"
          >
            <svg viewBox="0 0 24 24" className="w-5 h-5 text-[var(--accent-text)]" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="flex justify-center md:justify-end">
          <TiltCard className="w-80 h-80 rounded-full overflow-hidden shadow-2xl border-4 border-[var(--card-border)] cursor-pointer transition-shadow duration-300 hover:shadow-[0_0_30px_8px_rgb(var(--accent)/0.6)]">
            <img
              src="/profile.jpg"
              alt="Profile Picture"
